...
public:
    ...
    /*! \brief Application shutdown code */
    void shutdown(void);
     ...
     */
    std::string get_curmap(void);
    /*! \brief Setter for current map name.
     */
    void set_curmap(std::string curmap);
...
extern uint8_t hold_fade, cansave, skip_intro, wait_retrace, cpu_usage;
extern bool should_stretch_view, windowed;
